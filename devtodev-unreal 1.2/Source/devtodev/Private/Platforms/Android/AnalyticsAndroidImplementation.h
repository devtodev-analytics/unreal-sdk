#ifndef AnalyticsAndroidImplementation_h
#define AnalyticsAndroidImplementation_h

#include "../../Analytics/DTDAnalyticsImplementation.h"

namespace devtodev {
    class AnalyticsAndroidImplementation : public DTDAnalyticsImplementation {
      public:
        explicit AnalyticsAndroidImplementation();
        virtual ~AnalyticsAndroidImplementation();
...
#endif /* AnalyticsAndroidImplementation_h */
