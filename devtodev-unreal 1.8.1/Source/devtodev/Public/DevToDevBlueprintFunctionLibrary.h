...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Analytics")
    static void  EndProgressionEvent(const FString& locationName, const TArray<FAnalyticsEventAttr>& Attributes, const TArray<FAnalyticsEventAttr>& Earned, const TArray<FAnalyticsEventAttr>& Spent);
};
